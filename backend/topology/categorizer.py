...
# Vendor keywords
NETWORK_VENDORS = {
    "cisco", "mikrotik", "fortinet", "fortigate", "juniper",
    "ubiquiti", "aruba", "tp-link",
}
...
def _categorize_single(host: dict[str, Any]) -> str:
    ...
    if open_ports & CAMERA_PORTS and (
        any(v in os_name for v in CAMERA_VENDORS) or 554 in open_ports
    ):
        return "camera"
